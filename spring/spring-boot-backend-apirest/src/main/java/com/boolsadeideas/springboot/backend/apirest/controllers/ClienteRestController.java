...
import com.boolsadeideas.springboot.backend.apirest.models.services.IUploadFileService;
	...
	public ResponseEntity<?> upload(@RequestParam("archivo") MultipartFile archivo, @RequestParam("id") Long id){
		...
		if(!archivo.isEmpty()) {
			...
			try {
				...
				response.put("mensaje","Error al cargar la imagen del usuario en la BD");
