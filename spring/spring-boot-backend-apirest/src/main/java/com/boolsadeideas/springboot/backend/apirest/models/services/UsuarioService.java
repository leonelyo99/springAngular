...
import com.boolsadeideas.springboot.backend.apirest.models.dao.IUsuarioDao;
...
public class UsuarioService implements IUsuarioService, UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(usuario == null) {
			logger.error("Error en el login: no existe ese usuario");
		...
		//en el log retorna el token del usuario logueado
